  ...
  <div id="main">
    ...
    <div class="wrapper">
                        ...
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-question-answer"></i> Feedback</a>
                            <div class="collapsible-body">
								...
								if(!isset($_GET['status'])){
									...
									"><a href="tickets.php">All Questions</a>
                                </li>
								<?php
      ...
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">If you're experiencing any issues, contact us by opening a new feedback option.</p>
          <div class="divider"></div>
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Open a feedback form</h4>
              </div>
<div>
      ...
      <!-- END CONTENT -->
	        ...
	        <!--start container-->
        <div class="container">
          <p class="caption">List of your feedbacks</p>
          <div class="divider"></div>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2018 <a class="grey-text text-lighten-4" href="#" target="_blank">Students</a> All rights reserved.</span>
